...
/* Formatting search box */
    ...
    .market-search-box input[type="text"], .result{
        width: 100%;
	...
	<script type="text/javascript">
$(document).ready(function(){
    $('.market-search-box input[type="text"]').on("keyup input", function(){
        /* Get input value on change */
        var inputVal = $(this).val();
        var resultDropdown = $(this).siblings(".result");
        if(inputVal.length){
            $.get("market-backend-search.php", {term: inputVal}).done(function(data){
    ...
    $(document).on("click", ".result p", function(){
        ...
        $(this).parents(".market-search-box").find('input[type="text"]').val('');
...
?>
	...
	Total Number of Campaigns: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
	</div>
</div>
...
<a rel="facebox" href="addcampaign.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> New Campaign </button></a></ul><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><a title="Click To Edit Campaign" rel="facebox" href="editcampaign.php?id=<?php echo $sid; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button></a> 
				
			<a href="deleteCampaign.php?id=<?php echo $sid; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini"><i class="icon-trash"></i> Delete</button></a></td>
			</tr>
			<?php
			}
			?>
