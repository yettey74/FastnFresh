...
<form action="saverecipe.php" method="post">
	<center>
		<h4><i class="icon-plus-sign icon-large"></i> Add Recipe</h4>
	</center>
	<hr>
	<div id="ac">
			<?php
	...
	?>
	<br><br>
		<input type="text" style="width:265px; height:30px;" name="recipe_title" placeholder="Recipe Name" Required /><br>
	<br>
		<br>
		<textarea style="width:265px; height:30px;" name="recipe_blurb" placeholder="Recipe Blurb" /></textarea><br>
		<br>
		<input type="file" name="recipe_image" />
		<input type="text" style="width:265px; height:30px;" name="recipe_link" placeholder="Recipe Link" /><br>
	<br>
	<br>
		<label>Status</label>				
