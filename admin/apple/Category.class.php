 ...
 * @author        Golith 
 * @link        https://www.itsystemsdesign.com.au 
 */ 
class Product {  
    ...
    private $dbPassword = ""; 
    private $dbName     = "ffp"; 
    private $userTbl    = "product";
    private $name = "productName";
    private $blurb = "productBlurb";
    ...
    /** 
     * Cart Contents: Returns categoryName 
     * @param    bool 
     * @return    string 
     */ 
    public function setCategoryName( $cn ){ 
		return (this.$categoryName = $cn)? TRUE: FALSE;
    } 
     ...
     * @return    bool 
     */ 
    public function updatePrice($item = array()){ 
        if (!is_array($item) OR count($item) === 0){ 
            return FALSE; 
        }else{ 
            if (!isset($item['rowid'], $this->cart_contents[$item['rowid']])){ 
