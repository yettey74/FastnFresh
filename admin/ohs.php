...
<html>
  <head>
  <meta charset="utf-8">
  <title>Occupational Health &amp; Safety View</title>
...
<?php 
			include('db.php');
				$result = $conn->prepare("SELECT * FROM ohs");
				$result->execute();
				$rowcount = $result->rowcount();
			?>
			<div id="count" style="text-align:center;">
			Total Number of O.H.S Policies: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
			</div>
</div>

<div class="ohs-search-box">
	<input type="text" autocomplete="off" placeholder="Search O.H.S..." id="search" name="search" onBlur="clear()" value=""/>
	<div class="result"></div>
</div>

<a rel="facebox" href="addohs.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> New O.H.S Record</button></a></ul><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo $row['ohsTitle'] ; ?></td>
			<td><?php echo $row['ohsBlurb']; ?></td>
			
			<td>
				<a title="Click To Edit Policy" rel="facebox" href="editohs.php?id=<?php echo $ohs_id; ?>">
				<button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button>
				</a>
				
				<a href="#" id="<?php echo $ohs_id; ?>" class="delbutton" title="Click To Delete">
