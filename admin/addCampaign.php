...
<form action="savecampaign.php" method="post">
	<center>
		<h4><i class="icon-plus-sign icon-large"></i> Add Special</h4>
	</center>
	<hr>
	<div id="ac">
			<?php
	...
	?>
	<br><br>
		<input type="text" style="width:265px; height:30px;" name="specialTitle" placeholder="Special Name" Required /><br>
	<br>
		<br>
		<textarea style="width:265px; height:30px;" name="specialBlurb" placeholder="Special Blurb" /></textarea><br>
		<br>
		<input type="file" name="specialImage" />
