...
?>
		...
		<form action="updateRecipe.php" method="post">
			<center><h4><i class="icon-edit icon-large"></i> Edit Recipe</h4></center>
			<hr>
			<div id="ac">			
				<span style="text-align: center; color:red;"><strong>Recipe Details</strong></span>
			<br>
			<?php
	...
	<br><br>
			<label>Name</label>
			<input type="text" style="width:265px; height:30px;" name="recipe_title" value="<?php echo $row['recipe_title']; ?>" />
			<br>
			<label>Blurb</label>
			<input type="text" style="width:265px; height:30px;" name="recipe_blurb" value="<?php echo $row['recipe_blurb']; ?>" />
			<br>
			<label>Image</label>
			<input type="text" style="width:265px; height:30px;" name="recipe_image" value="<?php echo $row['recipe_image']; ?>" />
			<br>
			<label>Link</label>
			<input type="text" style="width:265px; height:30px;" name="recipe_link" value="<?php echo $row['recipe_link']; ?>" />
			<br>
			<label>Status</label>
				<?php if( $row['status'] == 1 ){?>
