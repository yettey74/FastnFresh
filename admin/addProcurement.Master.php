...
<div class="shop">
	...
	<li><a href="srm.php">Procurements</a></li>
	<li>Purchase Order</li>
<div class="container">
	<div class="search-box">
        <input type="text" autocomplete="off" placeholder="Add Variety ..." />
                ...
                <div class="table-responsive">
                    <table class="table table-striped">						
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
									<span style="font-size: 14px; font-style: normal; font-weight:bolder;"><?php echo $item["name"] . ' ' . $item["productName"]; ?></span>
									<br>
								...
								<td>
									...
									foreach( $uomArray as $key=>$value ){
										if( $key == $item['type']){
											echo '<option value="' . $key . '" selected="">' . getUomLong( $conn, $key ). ' $' . number_format( $value, 2, '.', ',') . '</option>';	
										} else {
											echo '<option value="' . $key . '">' . getUomLong( $conn, $key ). ' $' . number_format( $value, 2, '.', ',') . '</option>';
										}
                            ...
                            <tr><td colspan="6"><p>New Purchase Order.</p></td>
                            <?php } ?>
                ...
                <div class="row">
                   <!-- <div class="col-sm-12  col-md-6">
                    ...
                    <div class="col-sm-12 col-md-6 text-right">
						...
						if($cart->total_items() > 0){ 
							echo '<div>';
							echo '<a href="raiseOrder.php" class="btn btn-lg btn-block btn-success">Raise Order</a>';
							echo '</div>';
						}
						?>
                    </div>
