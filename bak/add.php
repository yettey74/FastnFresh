...
<?php
	...
	foreach($uomR as $uom)
	{
		echo '<input type="checkbox" name="' . $uom['uomName'] . '" value="' . $uom['uomid'] . '"> ' . $uom['uomName'];	
	}
	echo '<td></tr>';
	echo '<tr>';				
		echo '<td>';
	...
	echo '</tr>';
	echo '<tr>';
	echo '<td><input type="text" placeholder="Variety Name" value="" id="ptname" name="ptname"></td>';
	echo '</tr>';
	echo '<tr>';
	echo '<td><input type="text" placeholder="Variety Image" value="" id="ptimage" name="ptimage"></td>';
	echo '</tr>';
	echo '<tr>';
	echo '<td><input type="text" placeholder="Variety Price" value="" id="ptprice" name="ptprice"></td>';
	echo '</tr>';
	echo '<tr>';
	echo '<td><input type="text" placeholder="Variety Blurb" value="" id="ptblurb" name="ptblurb"></td>';
	echo '</tr>';
	echo '<tr>';
	echo '<td><input type="text" placeholder="Variety Receipe" value="" id="ptreceipe" name="ptreceipe"></td>';
	echo '</tr>';

	echo'<tr><td><input type="submit" value="submit" id="ptadd-submit" name="ptadd-submit"><input type="button" value="No, go back!" onclick="history.go(-1)"></td></tr>';
	echo '</table>';				
	echo '</form>';	
?>
